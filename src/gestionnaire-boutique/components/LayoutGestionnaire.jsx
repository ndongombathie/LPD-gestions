  ...
  return (
    <div className="flex h-screen bg-gray-50 text-gray-900 overflow-hidden">
      ...
      <div className="flex flex-col flex-1 min-h-0 ml-64">
        ...
        <main className="flex-1 overflow-y-auto bg-linear-to-b from-white to-gray-50 px-2 sm:px-4 md:px-6 py-4 sm:py-5 pb-20 w-full">
          <div className="w-full max-w-400 mx-auto">
            {children ?? <Outlet />}
          </div>
        </main>
        
        <footer className="shrink-0 fixed bottom-0 left-64 right-0 z-20 bg-white border-t border-gray-200 shadow-inner text-sm text-gray-500 text-center py-4">
